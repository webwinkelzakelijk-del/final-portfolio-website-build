...
const en: Record<ServiceKey, ServiceContent> = {
  websites: {
    ...
    faq: {
      ...
      items: [
        ["How much does a custom website cost?", "A custom website starts from €499 excl. VAT, for example for a compact website or landing page. The final price depends on the scope: a landing page is different from a multilingual business website. After an introduction you'll receive a proposal with a clear price, so you know where you stand upfront."],
